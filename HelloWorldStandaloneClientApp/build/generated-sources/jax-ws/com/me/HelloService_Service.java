 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://me.com/", wsdlLocation = "http://localhost:8080/HelloWorldWSApp/HelloService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://me.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/HelloWorldWSApp/HelloService?WSDL");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://me.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://me.com/", "HelloServicePort"), HelloService.class, features);
    }
